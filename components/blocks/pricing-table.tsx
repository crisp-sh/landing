  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-8">
          {plans.map((plan) => (
            <button
              ...
              className={cn(
                "flex-1 p-4 rounded-none text-left transition-all",
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                {plan.popular && (
                  <span className="text-xs bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 px-2 py-0.5 rounded-none">
                    Popular
                  </span>
                )}
              </div>
        ...
        <div className="border border-zinc-200 dark:border-zinc-800 rounded-none overflow-hidden">
        ...
        <div className="mt-8 text-center">
          <Button
            className={cn(
              "w-full sm:w-auto bg-blue-500 hover:bg-blue-600 px-8 py-2 rounded-none",
              buttonClassName,
            )}
          >
