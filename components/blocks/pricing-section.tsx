    ...
    >
      <div className="w-full max-w-5xl mx-auto">
        <div className="flex flex-col items-center gap-4 mb-12">
          ...
          <div className="inline-flex items-center p-1.5 bg-white dark:bg-zinc-800/50 rounded-none border border-zinc-200 dark:border-zinc-700 shadow-sm">
            {["Monthly", "Yearly"].map((period) => (
              ...
              <button
                ...
                className={cn(
                  "px-8 py-2.5 text-sm font-medium rounded-none transition-all duration-300",
                ...
                <div className="space-y-4">
                  {tier.features.map((feature) => (
                    <div key={feature.name} className="flex gap-4">
                      <div
                        className={cn(
                          "mt-1 p-0.5 rounded-none transition-colors duration-200",
                          feature.included
